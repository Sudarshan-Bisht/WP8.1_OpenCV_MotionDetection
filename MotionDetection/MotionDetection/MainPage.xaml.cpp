...
namespace MotionDetection {
    ...
    MainPage::MainPage()
    {
        ...
        Window::Current->VisibilityChanged += ref new Windows::UI::Xaml::WindowVisibilityChangedEventHandler(this, &MotionDetection::MainPage::OnVisibilityChanged);
    ...
    void MotionDetection::MainPage::OnVisibilityChanged(Platform::Object ^sender,
